...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Session.sessiontype'
        db.add_column(u'confsessions_session', 'sessiontype',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['confsessions.SessionType']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Session.sessiontype'
        db.delete_column(u'confsessions_session', 'sessiontype_id')
