...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SessionType.use_search_bar'
        db.add_column(u'confsessions_sessiontype', 'use_search_bar',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SessionType.use_search_bar'
        db.delete_column(u'confsessions_sessiontype', 'use_search_bar')
