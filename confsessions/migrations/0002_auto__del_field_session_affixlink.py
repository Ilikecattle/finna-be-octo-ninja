...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Session.affixlink'
        db.delete_column(u'confsessions_session', 'affixlink')


    def backwards(self, orm):
        # Adding field 'Session.affixlink'
        db.add_column(u'confsessions_session', 'affixlink',
                      self.gf('django.db.models.fields.CharField')(default='link', max_length=10),
                      keep_default=False)
