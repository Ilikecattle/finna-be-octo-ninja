...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'confsessions_sessiontime', 'time', self.gf('django.db.models.fields.TimeField')())

    def backwards(self, orm):

        # Changing field 'SessionTime.time'
        db.alter_column(u'confsessions_sessiontime', 'time', self.gf('django.db.models.fields.DateTimeField')())
