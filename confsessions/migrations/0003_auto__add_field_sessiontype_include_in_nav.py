...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SessionType.include_in_nav'
        db.add_column(u'confsessions_sessiontype', 'include_in_nav',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SessionType.include_in_nav'
        db.delete_column(u'confsessions_sessiontype', 'include_in_nav')
    ...
    models = {
        ...
        u'confsessions.sessiontype': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'include_in_nav': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
