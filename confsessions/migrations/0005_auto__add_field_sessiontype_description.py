...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SessionType.description'
        db.add_column(u'confsessions_sessiontype', 'description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2000),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SessionType.description'
        db.delete_column(u'confsessions_sessiontype', 'description')
