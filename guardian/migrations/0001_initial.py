...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'UserObjectPermission', fields ['user', 'permission', 'content_type', 'object_pk']
        db.create_unique('guardian_userobjectpermission', ['user_id', 'permission_id', 'content_type_id', 'object_pk'])
        ...
        # Adding unique constraint on 'GroupObjectPermission', fields ['group', 'permission', 'content_type', 'object_pk']
        db.create_unique('guardian_groupobjectpermission', ['group_id', 'permission_id', 'content_type_id', 'object_pk'])


    def backwards(self, orm):
        # Removing unique constraint on 'GroupObjectPermission', fields ['group', 'permission', 'content_type', 'object_pk']
        db.delete_unique('guardian_groupobjectpermission', ['group_id', 'permission_id', 'content_type_id', 'object_pk'])

        # Removing unique constraint on 'UserObjectPermission', fields ['user', 'permission', 'content_type', 'object_pk']
        db.delete_unique('guardian_userobjectpermission', ['user_id', 'permission_id', 'content_type_id', 'object_pk'])
