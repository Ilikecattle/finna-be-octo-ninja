...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Profile.gluten'
        db.delete_column(u'profiles_profile', 'gluten')

        # Deleting field 'Profile.nut_allergy'
        db.delete_column(u'profiles_profile', 'nut_allergy')

        # Deleting field 'Profile.lactose'
        db.delete_column(u'profiles_profile', 'lactose')


    def backwards(self, orm):
        # Adding field 'Profile.gluten'
        db.add_column(u'profiles_profile', 'gluten',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Profile.nut_allergy'
        db.add_column(u'profiles_profile', 'nut_allergy',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Profile.lactose'
        db.add_column(u'profiles_profile', 'lactose',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    models = {
        ...
        u'confsessions.sessiontime': {
            ...
            'time': ('django.db.models.fields.TimeField', [], {'default': 'datetime.datetime(2013, 11, 10, 0, 0)', 'null': 'True'})
        },
