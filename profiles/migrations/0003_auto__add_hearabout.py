...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('profiles_hearabout', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=300)),
        ))
        db.send_create_signal('profiles', ['HearAbout'])

        # Adding M2M table for field hear on 'Profile'
        db.create_table('profiles_profile_hear', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('profile', models.ForeignKey(orm['profiles.profile'], null=False)),
            ('hearabout', models.ForeignKey(orm['profiles.hearabout'], null=False))
        ))
        db.create_unique('profiles_profile_hear', ['profile_id', 'hearabout_id'])


    def backwards(self, orm):
        # Deleting model 'HearAbout'
        db.delete_table('profiles_hearabout')

        # Removing M2M table for field hear on 'Profile'
        db.delete_table('profiles_profile_hear')
    ...
    models = {
        ...
        'profiles.profile': {
            ...
            'hear': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['profiles.HearAbout']", 'symmetrical': 'False'}),
