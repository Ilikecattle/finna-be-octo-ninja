...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PaymentGroups.email'
        db.delete_column(u'profiles_paymentgroups', 'email')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'PaymentGroups.email'
        db.add_column(u'profiles_paymentgroups', 'email',
