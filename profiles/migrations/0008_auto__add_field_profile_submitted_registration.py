...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.submitted_registration'
        db.add_column(u'profiles_profile', 'submitted_registration',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.submitted_registration'
        db.delete_column(u'profiles_profile', 'submitted_registration')
    ...
    models = {
        ...
        u'confsessions.session': {
            ...
            'presenter': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'sessiontype': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['confsessions.SessionType']"}),
            'teaser': ('django.db.models.fields.CharField', [], {'max_length': '2000', 'blank': 'True'})
        },
        u'confsessions.sessiontime': {
            'Meta': {'ordering': "('time',)", 'object_name': 'SessionTime'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'time': ('django.db.models.fields.TimeField', [], {'default': 'datetime.datetime(2013, 11, 16, 0, 0)', 'null': 'True'})
        },
        u'confsessions.sessiontype': {
            ...
            'use_search_bar': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        ...
        u'profiles.profile': {
            ...
            'affiliation': ('django.db.models.fields.CharField', [], {'default': "'UBCStudent'", 'max_length': '25', 'null': 'True'}),
            'diet': ('django.db.models.fields.CharField', [], {'max_length': '25', 'null': 'True', 'blank': 'True'}),
            'faculty': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True'}),
            'gluten_free': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'hear': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['profiles.HearAbout']", 'null': 'True', 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lactose_intolerant': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'major': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'mugshot': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'blank': 'True'}),
            'paid': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'phone_num': ('django.db.models.fields.CharField', [], {'max_length': '15', 'null': 'True'}),
            ...
            'submitted_registration': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'times_participation': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            ...
            'year_of_study': ('django.db.models.fields.CharField', [], {'max_length': '2', 'null': 'True'})
        }
    }
