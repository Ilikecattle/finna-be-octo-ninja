...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PaymentGroups.primary'
        db.delete_column('profiles_paymentgroups', 'primary')

        # Adding field 'PaymentGroups.primary_group'
        db.add_column('profiles_paymentgroups', 'primary_group',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PaymentGroups.primary'
        db.add_column('profiles_paymentgroups', 'primary',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'PaymentGroups.primary_group'
        db.delete_column('profiles_paymentgroups', 'primary_group')
