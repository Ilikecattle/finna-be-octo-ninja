...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Profile.other_faculty'
        db.delete_column(u'profiles_profile', 'other_faculty')

        # Deleting field 'Profile.graduating'
        db.delete_column(u'profiles_profile', 'graduating')


    def backwards(self, orm):
        # Adding field 'Profile.other_faculty'
        db.add_column(u'profiles_profile', 'other_faculty',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.graduating'
        db.add_column(u'profiles_profile', 'graduating',
    ...
    models = {
        ...
        u'confsessions.sessiontime': {
            ...
            'time': ('django.db.models.fields.TimeField', [], {'default': 'datetime.datetime(2013, 11, 12, 0, 0)', 'null': 'True'})
        },
