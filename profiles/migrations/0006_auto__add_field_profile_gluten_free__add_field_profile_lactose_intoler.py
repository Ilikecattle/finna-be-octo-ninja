...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.gluten_free'
        db.add_column(u'profiles_profile', 'gluten_free',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Profile.lactose_intolerant'
        db.add_column(u'profiles_profile', 'lactose_intolerant',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.gluten_free'
        db.delete_column(u'profiles_profile', 'gluten_free')

        # Deleting field 'Profile.lactose_intolerant'
        db.delete_column(u'profiles_profile', 'lactose_intolerant')
