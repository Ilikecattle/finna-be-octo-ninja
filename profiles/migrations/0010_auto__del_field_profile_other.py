...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Profile.other'
        db.delete_column(u'profiles_profile', 'other')
    ...
    def backwards(self, orm):
        # Adding field 'Profile.other'
        db.add_column(u'profiles_profile', 'other',
                      self.gf('django.db.models.fields.TextField')(default='Maybe try setting a goal...', blank=True),
                      keep_default=False)
