...
urlpatterns = patterns('',
    ...
    # Payment
    url(r'^payment/(\d*)/(\d*)/$', userena_views.payment, name='payment'),
    url(r'^paymentsuccess/$', userena_views.payment_success, name='payment_success'),
    url(r'^grouppayment/$', userena_views.group_payment, name='group_payment'),
    url(r'^updateprimary/$', userena_views.update_primary_group, name='update_primary'),
    url(r'^delegatecount/$', userena_views.countdelegates, name='delegate_count'),
