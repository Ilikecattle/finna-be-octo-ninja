...
#
# Turkish <kde-i18n-doc@kde.org>, 2012.
# Gokmen Gorgen <gokmen@alageek.com>, 2013.
msgid ""
msgstr ""
"Project-Id-Version: \n"
"Report-Msgid-Bugs-To: \n"
"POT-Creation-Date: 2012-05-06 19:54+0300\n"
"PO-Revision-Date: 2013-05-10 13:37+0300\n"
"Last-Translator: Gokmen Gorgen <gokmen@alageek.com>\n"
"Language-Team: Turkish <translation@radity.com>\n"
"Language: tr\n"
"MIME-Version: 1.0\n"
...
msgstr ""
"Kullanıcı adı sadece harfler, rakamlar, nokta ve alt çizgiden oluşmalıdır."
...
msgstr "Bu kullanıcı adını alamazsınız."

#: forms.py:61 forms.py:195
msgid "This email is already in use. Please supply a different email."
msgstr "Bu e-posta zaten kullanımda. Lütfen farklı bir e-posta adresi yazınız."
...
msgstr "Kullanım şartlarını okudum ve kabul ediyorum."

#: forms.py:118
msgid "You must agree to the terms to register."
msgstr "Kayıt olabilmek için şartları kabul etmelisiniz."
...
msgstr "E-posta adresinizi veya kullanıcı adınızı giriniz."
...
msgstr "Beni %(days)s gün boyunca hatırla"

#: forms.py:154
msgid "Please supply your email."
msgstr "E-posta adresinizi yazınız."
...
"are case-sensitive."
msgstr ""
"Lütfen doğru bir kullanıcı adı / e-posta ve parola yazınız. İki alan da büyük "
...
msgstr "Zaten bu e-posta ile biliniyorsunuz."
...
msgstr "%(username)s için profil bulunamadı"
...
msgstr "Bu kullanıcının etkin olduğu son tarih."
...
"their account."
msgstr ""
"Kullanıcının hesabını etkinleştirmesi için bildirim alıp almadığını gösterir."

#: models.py:62
msgid "unconfirmed email address"
msgstr "doğrulanmamış e-posta adresi"

#: models.py:64
msgid "Temporary email address when the user requests an email change."
msgstr ""
"Kullanıcı e-posta değişikliği talep ettiğinde verdiği geçici e-posta adresi."

#: models.py:66
msgid "unconfirmed email verification key"
msgstr "doğrulanmamış e-posta doğrulama anahtarı"

#: models.py:70
msgid "creation date of email confirmation key"
msgstr "e-posta doğrulama anahtarının oluşturulma tarihi"

#: models.py:78
msgid "userena registration"
msgstr "userena kayıt"

#: models.py:79
msgid "userena registrations"
msgstr "userena kayıtları"
...
msgstr "Profilinizde gösterilen kişisel resim."
...
msgstr "Profilinizi kimin görebileceğini gösterir."
...
msgstr "Hesabınız etkinleştirilmiştir ve siteye giriş yapmış bulunmaktasınız."
...
msgstr "Bu profili görmeye yetkiniz yok."
...
msgstr "Şu kullanıcı adları doğru değil: %(users)s."
...
msgstr "%(um_from_user)s ve %(um_to_user)s"
...
msgstr "göndericinin silme tarihi"
...
"link has aged."
msgstr ""
"Hesabınız etkinleştirilemedi. Etkinleştirme bağlantısının süresi dolmuş "
"olabilir."
...
msgstr ""
"Eğer size karşı bir haksızlık yapıldığını düşünüyorsanız yöneticilere "
"ulaşarak kapatılma sebebini sorabilirsiniz"
...
msgstr "Yeni e-posta adresinizi doğrulayın"

#: templates/userena/email_change_complete.html:8
#, python-format
msgid "You have received an email at %(email)s."
msgstr "%(email)s adresinize bir e-posta almış olmalısınız."
...
msgstr ""
"Bu e-posta adresiyle hesabınızı (%(username)s) ilişkilendirmek için bu "
"e-postada yazılı bağlantıya tıklayınız."
...
"email."
msgstr ""
"Yeni e-posta adresiniz kaydedildi. %(site)s kullanmaya bu e-posta ile devam "
"edebilirsiniz."

#: templates/userena/email_confirm_fail.html:4
msgid "Email verification failed."
msgstr "E-posta doğrulama başarısız oldu."
...
msgstr "Bundan sonra girişlerde yeni parolanızı kullanabilirsiniz"
...
msgstr "Parolanız sıfırlanmıştır"
...
msgstr ""
"Şimdi yeni parolanızla <a href=\"%(signin_url)s\">giriş</a> yapabilirsiniz."
...
msgstr ""
"Parolanızı nasıl sıfırlayacağınızı açıklayan bir e-posta, adresinize "
"gönderildi."

#: templates/userena/password_reset_form.html:13
msgid "Send password"
msgstr "Parola gönder"
...
msgstr "Çıkış yaptınız, tekrar buluşana kadar..."

#: templates/userena/signup_complete.html:4
msgid "Signup almost done!"
msgstr "Kayıt bitmek üzere!"
...
msgstr ""
"Sunduğunuz e-posta adresine etkinleştirme bağlantısı içeren bir e-posta "
"gönderilmiştir."
...
"on our server. "
msgstr "Kayıt bilgilerinizi %(userena_activation_days)s gün saklayacağız."

#: templates/userena/signup_complete.html:15
msgid "You can now use the supplied credentials to signin."
msgstr "Şimdi giriş için sunulan bilgileri kullanabilirsiniz."
...
msgstr ""
"%(site)s üzerinde kayıtlı e-posta adresinizi değiştirme talebinde bulundunuz."
...
msgstr ""
"Lütfen bu e-posta adresinizi aşağıdaki bağlantıya tıklayarak doğrulayın:"
...
msgstr ""
"%(site)s üzerinde kayıtlı e-posta adresinizi değiştirme talebinde bulunuldu."
...
msgstr ""
"%(new_email)s adresine doğrulama bağlantısını içeren bir e-posta gönderildi. "
"Bu bağlantıya tıklayarak hesabınızı etkinleştirebilirsiniz."

#: templates/userena/emails/confirmation_email_subject_new.txt:2
#, python-format
msgid "Email verification for %(site)s."
msgstr "%(site)s için e-posta doğrulaması."
...
msgstr ""
"Bu e-postayı alıyorsunuz çünkü %(site_name)s hesabınızın \n "
"parolasını sıfırlama talebinde bulundunuz."

#: templates/userena/emails/password_reset_message.txt:5
msgid "Please go to the following page and choose a new password:"
msgstr "Lütfen şu sayfaya gidin ve yeni bir parola belirleyin:"
...
msgstr ""
"\n"
"Kullanıcı adınız, unuttuysanız: %(username)s\n"
