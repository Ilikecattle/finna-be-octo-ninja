...
msgstr "Este username já existe"

#: forms.py:55
msgid "This username is not allowed."
msgstr "Este username não é permitido"
...
msgstr "Os dois campos de passwords não correspondem."
...
msgstr "Tem que concordar com os Termos de Serviço"
...
"are case-sensitive."
msgstr ""
"Por favor insira um username correcto ou e-mail e password. Note-se que "
"ambos os campossão case-sensitive"
...
#: models.py:53
msgid "last active"
msgstr "Activo pela última vez"

#: models.py:56
msgid "The last date that the user was active."
msgstr "A última data que o utilizador esteve ativo."
...
"their account."
msgstr ""
"Determina se este utilizador já recebeu uma notificação sobre a activaçãoda "
"sua aconta"
...
msgstr "Email temporário quando o utilizador solicita uma mudança de e-mail."
...
msgstr "A imagem pessoal exibida no seu perfil."
...
msgstr "Designa quem pode ver seu perfil."
...
msgstr "Sua conta foi activada e autentidada"
...
msgstr "Não tem permissão para visualizar ester perfil"
...
msgstr "Os seguintes usernames estão incorrentos: %(users)s."
...
"link has aged."
msgstr ""
"A sua conta não pode activada. Isto pode estar a acontecer porqueo seu link "
"não se encontra mais registado"

#: templates/userena/activate_fail.html:9
msgid ""
"Please try signing up again or contact us if you think something went wrong."
msgstr ""
"Por favor, tente inscrever-se novamente ou contacte-nos se pensa que algo "
"está errado."
...
msgstr ""
"Se acha que é uma injustica o que acontece, não hesite em contactaros "
"administradores para descobrir o porquê"

#: templates/userena/email_change_complete.html:4
msgid "Email verification"
msgstr "Email de verificação"
...
msgstr "Recebeu um e-mail em %(email)s."
...
"email."
msgstr ""
"O seu novo email foi guardado. Pode continuar a usar userrena com esteemail"

#: templates/userena/email_confirm_fail.html:4
msgid "Email verification failed."
msgstr "Verificação de email sem sucesso"
...
msgstr "Pode tentar alterar novamente nas configurações de conta"
...
msgstr "A sua password foi alterada"

#: templates/userena/password_complete.html:8
msgid "From now on you can use your new password to signin"
msgstr "A partir de agora pode usar a sua nova password para entrar"
...
msgstr "A sua password foi renovada"
...
msgstr ""
"Foi-lhe enviado um email com o link de activação para o email que forneceu"
...
"on our server. "
msgstr ""
"Vamos armazenar a usa informação de inscrição por "
"%(userena_activation_days)s dias no nosso servidor. "
