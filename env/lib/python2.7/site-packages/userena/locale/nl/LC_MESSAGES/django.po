...
#: forms.py:61 forms.py:191
msgid "This email is already in use. Please supply a different email."
msgstr "Deze e-mail is reeds in gebruik. Geef een ander e-mail adres op."
...
msgstr "Ik heb de algemene voorwaarden gelezen en ga hiermee akkoord"

#: forms.py:114
msgid "You must agree to the terms to register."
msgstr "Je moet akkoord gaan met de algemene voorwaarden."
...
msgstr "Hou me ingelogd voor %(days)s"
...
"are case-sensitive."
msgstr ""
"Vul alsjeblieft een correcte gebruikersnaam of e-mailadres in gecombineerd "
"met je wachtwoord."
...
msgstr "Je staat al bekend onder dit e-maildres."
...
msgstr "De laatste datum dat deze gebruiker actief was."
...
"their account."
msgstr ""
"Verteld ons of deze gebruiker al een notificatie heeft gehad over het "
"activeren van zijn account."

#: models.py:66
msgid "unconfirmed email address"
msgstr "ongeconfirmeerd e-mail adres"

#: models.py:68
msgid "Temporary email address when the user requests an email change."
msgstr ""
"Tijdelijke e-mailadres wanneer de gebruiker een wijziging heeft aangevraagd."

#: models.py:70
msgid "unconfirmed email verification key"
msgstr "nieuw email verificatie sleutel"

#: models.py:74
msgid "creation date of email confirmation key"
msgstr "creatie datum van activatie sleutel"

#: models.py:82
msgid "userena registration"
msgstr "userena registratie"

#: models.py:83
msgid "userena registrations"
msgstr "userena registraties"
...
msgstr "Een persoonlijk plaatje voor je profiel."
...
msgstr "Bepaald wie jouw profiel kan zien."
...
msgstr "De wijzigingen aan je account zijn opgslagen."

#: views.py:536
msgid "You don't have permission to view this profile."
msgstr "Je hebt geen toestemming om dit profiel te bekijken."
...
msgstr "%(um_from_user)s en %(um_to_user)s"
...
msgstr "ontvanger verwijderd op"
...
msgstr "verzender verwijderd op"
...
msgstr[0] "Bericht is hersteld."
msgstr[1] "Berichten zijn hersteld."

#: contrib/umessages/views.py:267
msgid "Message is successfully removed."
msgid_plural "Messages are successfully removed."
msgstr[0] "Bericht is verwijderd."
msgstr[1] "Berichten zijn verwijderd."
...
msgstr "Account activeren is mislukt."

#: templates/userena/activate_fail.html:5
msgid "Your account could not be activated..."
msgstr "Je account kon niet geactiveerd worden..."
...
"link has aged."
msgstr ""
"Je account kon niet geactiveerd worden. Dit kan gebeurd zijn doordat de link "
"die je gebruikt hebt niet meer geldig is."

#: templates/userena/activate_fail.html:9
msgid ""
"Please try signing up again or contact us if you think something went wrong."
msgstr ""
"Probeer alsjeblieft nogmaals te registreren of neem contact met ons op als "
"jedenkt dat er wat mis is gegaan."
...
msgstr ""
"Als je denkt dat dit niet correct is, neem dan contact met ons op zodat wij "
"het verder kunnen uitzoeken"

#: templates/userena/email_change_complete.html:4
msgid "Email verification"
msgstr "E-mail verificatie voor"
...
msgstr "Je hebt een e-mail ontvangen op %(email)s."
...
msgstr ""
"Om dit e-mail adres te koppelen aan je account (%(username)s) dien je op de "
"link te klikken in deze e-mail."
...
"email."
msgstr ""
"Je nieuwe e-mail adres is opgeslagen. Je kunt nu doorgaan met het gebruiken "
"van de site."

#: templates/userena/email_confirm_fail.html:4
msgid "Email verification failed."
msgstr "E-mail verificatie is mislukt."
...
msgstr "Jouw e-mail kon niet geverifieerd worden..."

#: templates/userena/email_confirm_fail.html:9
msgid "You could try changing it again in your account settings."
msgstr "Je kan het nogmaals proberen te wijzigen bij je account instellingen."
...
msgstr "Vanaf nu kan je dit wachtwoord gebruiken om in te loggen"
...
msgstr "Email om je wachtwoord te verzenden is verstuurd"

#: templates/userena/password_reset_done.html:8
msgid ""
"An e-mail has been send to you which explains how to reset your password."
msgstr ""
"Een e-mail is verstuurd, met daarin de uitleg hoe het wachtwoord kan worden "
"gewijzigd."
...
msgstr "Je bent uitgelogd bij userena. Tot de volgende keer."
...
"on our server. "
msgstr ""
"We zullen al je informatie verwijderen wanneer je niet activeerd binnen "
"%(userena_activation_days)s dagen."
...
msgstr "Om je account te activeren moet je op de onderstaande link klikken:"
...
msgstr "Je hebt een verzoek ingediend om je e-mail adres te wijzigen op"
...
msgstr ""
"Confirmeer alsjeblieft dit e-mail adres door te klikken op de onderstaande "
"link:"
...
msgstr "Er was een verzoek om je e-mail te veranderen op"
...
msgstr ""
"Een e-mail is verstuurd naar %(new_email)s welke een link bevat waarmee je "
"het nieuwe adres kunt verifieeren."
...
msgstr "Een verzoek om je e-mail adres te wijzigen is gemaakt op"
...
msgstr ""
"Je ontvangt deze e-mail omdat je een wachtwoord wijziging hebt aangevraagd"

#: templates/userena/emails/password_reset_message.txt:5
msgid "Please go to the following page and choose a new password:"
msgstr ""
"Ga alsjeblieft naar de onderstaande pagina en kies een nieuw wachtwoord:"
...
msgstr "Jouw gebruikersnaam, in het geval dat je het vergeten bent:"
...
#~ msgid ""
#~ "Your account on %(site_name)s is about to expire in %(days_left)s days."
#~ msgstr "Je account op %(site_name)s is over %(days_left)s verlopen."

#~ msgid "To activate your account you should click on the link below"
#~ msgstr "Om je account te activeren moet je op de onderstaande link klikken"

#~ msgid "Your account on %(site_name)s is about to expire."
#~ msgstr "Jouw account op %(site_name)s is bijna verlopen."

#~ msgid "for your user account at %(site_name)s"
#~ msgstr "voor jouw account op %(site_name)s"
