...
msgstr "Attivazione account fallita"
...
"link has aged."
msgstr ""
"Il tuo account non può essere attivato. Il tuo link di attivazione potrebbe "
"essere scaduto."
...
msgstr ""
"Prova nuovamente a registrarti o contattati se pensi ci sia qualche problema."
...
msgstr "Sembra che il tuo account sia stato disattivato."
...
msgstr ""
"Se pensi di essere stato oggetto di qualche torno, sei pregato di contattare "
"gli amministratori per risolvere la questione."

#: templates/userena/email_change_complete.html:4
msgid "Email verification"
msgstr "Verifica dell'email"

#: templates/userena/email_change_complete.html:5
msgid "Confirm your new email"
msgstr "Conferma la nuova email"

#: templates/userena/email_change_complete.html:8
#, python-format
msgid "You have received an email at %(email)s."
msgstr "Hai ricevuto un'email a %(email)s."
...
msgstr ""
"Per associare questo indirizzo con il tuo account (%(username)s) clicca sul "
"link in questa email."
...
msgstr "Il tuo indirizzo email non può essere verificato..."
...
msgstr ""
"Puoi ora <a href=\"%(signin_url)s\">accedere</a> con la tua nuova password."
...
msgstr "Ti è stata inviata un'email con un link di attivazione."
...
"on our server. "
msgstr ""
"Conserveremo le tue informazioni di accesso per %(userena_activation_days)s "
"giorni. "
...
msgstr "Hai richiesto una modifica dell'email per %(site)s."
...
msgstr ""
"Si prega di conferma questo indirizzo email cliccando sul link sottostante:"
...
msgstr ""
"E' stata fatta una richiesta di cambiare il tuo indirizzo email per %(site)s."
...
msgstr ""
"E' stata inviata un'email a %(new_email)s che contiene un link di verifica. "
"Clicca sul link nel messaggio per attivare l'indirizzo."

#: templates/userena/emails/confirmation_email_subject_new.txt:2
#, python-format
msgid "Email verification for %(site)s."
msgstr "Email di verifica per %(site)s."
...
msgstr ""
"E' stata fatta una richeista di modifica dell'indirizzo email per %(site)s."
...
msgstr ""
"Hai ricevuto questa email perché hai richiesto il recupero della password "
"per il tuo account su %(site_name)s"

#: templates/userena/emails/password_reset_message.txt:5
msgid "Please go to the following page and choose a new password:"
msgstr ""
"Sei pregato di andare alla pagina seguente e impostare una nuova password:"
